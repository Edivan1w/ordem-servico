...
public class OrdemServicoContoller {
	...
	@PutMapping
	public ResponseEntity<OrdemServicoDto> update(@Valid @RequestBody OrdemServicoDto dto){
		return ResponseEntity.ok().body(new OrdemServicoDto(ordemServicoService.update(dto)));
	}
